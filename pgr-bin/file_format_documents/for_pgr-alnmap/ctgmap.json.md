...
The `ctgmap.json` file contains information about contig mappings between a reference genome and query contigs. It is generated by the `pgr align alnmap` tool and provides detailed alignment information in a JSON format.
